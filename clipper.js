...
(function ()
{
   ...
   */
    ...
    {
        ip.Value = new ClipperLib.FPoint();
        var b1, b2;
    ...
    {
        botPt.Value = new ClipperLib.FPoint(0, 0);
        var len = in_path.length;
        if (closed)
            while (len > 0 && (ClipperLib.FPoint.op_Equality(in_path[0], in_path[len - 1])))
                len--;
        if (len === 0)
            return false;
